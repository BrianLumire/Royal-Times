// components/TableControlsRides.tsx
"use client";
...
const TableControlsRides: React.FC<TableControlsRidesProps> = ({
  ...
  const filterableTables: Record<string, { key: string; options: string[] }> = {
    "Live Trips": { key: "paymentmethod", options: ["Mpesa", "Cash" ,"Bank"] },
    "Completed Trips": { key: "paymentmethod", options: ["Mpesa", "Cash" ,"Bank"] },
    "Cancelled Trips": { key: "paymentmethod", options: ["Mpesa", "Cash" ,"Bank"] },
  };

  // Define sortable columns for each table
  const sortableColumns: Record<string, string[]> = {
    "Live Trips": ["driver", "customer", "noofstops"],
    "Completed Trips": ["driver", "customer", "noofstops"],
    "Cancelled Trips": ["driver", "customer", "noofstops"],
  };
...
export default TableControlsRides;