// components/TableControlsCustomer.tsx
"use client";
...
const TableControlsCustomer: React.FC<TableControlsCustomerProps> = ({
  searchTerm,
  onSearchChange,
  onFilterClick,
  onSortClick,
  ...
  const filterableTables: Record<string, { key: string; options: string[] }> = {
    Online: { key: "inaride", options: ["Yes", "No"] },
  };
  ...
  const sortableColumns: Record<string, string[]> = {
    ...
    Deleted: ["name", "completed rides", "rating"],
    Blocked: ["name", "completed rides", "rating"],
  };
...
export default TableControlsCustomer;