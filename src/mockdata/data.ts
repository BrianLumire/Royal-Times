...
export const singleCustomerRidesColumns = [
  { header: "Route", accessor: "route" },
  { header: "Trip Cost", accessor: "tripCost" },
  { header: "Date", accessor: "date" },
  { header: "Rating", accessor: "rating" },
...
export const singleCustomerDeliveriesColumns = [
  { header: "Route", accessor: "route" },
  { header: "Delivery Cost", accessor: "deliveryCost" },
  { header: "Date", accessor: "date" },
  { header: "Rating", accessor: "rating" },
...
export const singleCustomerTransactionsColumns = [
  { header: "Driver", accessor: "driver" },
...
export const singleCustomerReviewsData = [
  ...
  },
  {
    ...
    rating: 4.2,
    tip: 1200,
    comment: "Very courteous driver",
  },
];

export const singleCustomerReviewsColumns = [
  { header: "Driver", accessor: "driver" },
  { header: "Trip Cost", accessor: "tripCost" },
  { header: "Date", accessor: "date" },
  { header: "Rating", accessor: "rating" },
